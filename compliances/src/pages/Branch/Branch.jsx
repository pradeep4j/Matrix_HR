...
import {branchCreates} from '../../store/actions/otherActions';
...
const schema = Yup.object({
    name: Yup.string('')
        ...
        .min(3, 'Branch Name must be minimum of 3 charactors')
        .max(30, 'Branch Name Name must be maximum of 30 charactors')          
});
...
const onBranchCreate = async (val,action) => {
    ...
    // api call        
    dispatch(branchCreates(postBody)); 
    action.resetForm();
